  ...
  return (
    <footer className="py-8 mt-auto bg-white border-t border-gray-200">
      <div className="container px-4 mx-auto">
        ...
        <div className="flex flex-wrap justify-center text-sm text-gray-600 gap-x-2 gap-y-1">
          <Link to="/find" className="hover:text-orange-500">Find</Link>
          <span className="text-gray-400">|</span>
          <Link to="/about" className="hover:text-orange-500">About Us</Link>
          <span className="text-gray-400">|</span>
          <Link to="/events" className="hover:text-orange-500">My Events</Link>
          <span className="text-gray-400">|</span>
          <Link to="/profile" className="hover:text-orange-500">Profile</Link>
          <span className="text-gray-400">|</span>
          <Link to="/faqs" className="hover:text-orange-500">FAQs</Link>
          <span className="text-gray-400">|</span>
          <Link to="/terms" className="hover:text-orange-500">Terms and Conditions</Link>
          <span className="text-gray-400">|</span>
